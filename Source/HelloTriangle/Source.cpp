...
void inicializaSprites(Shader *shader) {
	...
	int texIDGameOverScreen = setupTexture("../../Textures/screens/PNG/gameover.png", sprWidthGameOverScreen, sprHeightGameOverScreen);
	...
	int texIDVictoryScreen = setupTexture("../../Textures/screens/PNG/victory.png", sprWidthVictoryScreen, sprHeightVictoryScreen);
	...
	int texIDStartScreen = setupTexture("../../Textures/screens/PNG/start.png", sprWidthStartScreen, sprHeightStartScreen);
